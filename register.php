            ...
            <form method="POST">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    <div>
                        ...
                        <input type="text" name="first_name" value="<?php echo sanitize($_POST['first_name'] ?? ''); ?>" class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-amber-500 outline-none" required>
                    </div>
                    <div>
                        <label class="block text-sm font-semibold text-gray-600 mb-1">Last Name *</label>
                        <input type="text" name="last_name" value="<?php echo sanitize($_POST['last_name'] ?? ''); ?>" class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-amber-500 outline-none" required>
                    </div>
                </div>
                <div class="mb-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    ...
                    <div>
                        ...
                        <input type="password" name="confirm_password" class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-amber-500 outline-none" required>
                    </div>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    <div>
                        <label class="block text-sm font-semibold text-gray-600 mb-1">Phone *</label>
                        <input type="text" name="phone" value="<?php echo sanitize($_POST['phone'] ?? ''); ?>" class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-amber-500 outline-none" required>
                    </div>
                    <div>
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="nationality" value="<?php echo sanitize($_POST['nationality'] ?? ''); ?>" class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-amber-500 outline-none" required>
                </div>
                <div class="mb-6">
                    <label class="block text-sm font-semibold text-gray-600 mb-1">Address *</label>
                    <textarea name="address" rows="2" class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-amber-500 outline-none" required><?php echo sanitize($_POST['address'] ?? ''); ?></textarea>
                </div>
                <button type="submit" class="btn-primary w-full text-lg py-3"><i class="fas fa-user-plus mr-2"></i>Create Account</button>
            </form>
            <div class="text-center mt-6">
                <p class="text-gray-500">Already have an account? <a href="login.php" class="text-amber-500 font-semibold hover:underline">Sign In</a></p>
            </div>
        </div>
    </div>
</section>
