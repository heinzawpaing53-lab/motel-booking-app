    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-luxury-800 rounded-xl shadow-sm p-6 mb-8">
            <div class="flex items-center space-x-4">
                <div class="flex-1">
                    <h3 class="font-semibold text-lg text-luxury-100"><?php echo $room['room_name'] ?: 'Room '.$room['room_number']; ?></h3>
                    <p class="text-luxury-300 text-sm"><?php echo $room['type_name']; ?> - <?php echo $room['floor_name']; ?></p>
                    <p class="text-luxury-400 font-bold text-2xl mt-2"><?php echo formatCurrency($room['price_per_night']); ?> <span class="text-sm text-luxury-300 font-normal">/night</span></p>
                </div>
            </div>
        </div>
        <?php endif; ?>
        ...
        <form method="POST" class="bg-luxury-800 rounded-xl shadow-sm p-8" id="reservationForm">
            ...
            <h3 class="font-semibold text-lg mb-4 text-luxury-100"><i class="fas fa-calendar text-luxury-400 mr-2"></i>Booking Dates</h3>
            ...
            <h3 class="font-semibold text-lg mb-4 text-luxury-100"><i class="fas fa-users text-luxury-400 mr-2"></i>Guests</h3>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                <div>
                    <label class="block text-sm font-semibold text-luxury-300 mb-1">Adults</label>
                ...
                <div>
                    <label class="block text-sm font-semibold text-luxury-300 mb-1">Children</label>
            ...
            <h3 class="font-semibold text-lg mb-4 text-luxury-100"><i class="fas fa-clipboard-list text-luxury-400 mr-2"></i>Special Requests</h3>
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 mb-6">
                <?php foreach($specialRequests as $req): ?>
                <label class="flex items-center space-x-2 p-3 border border-luxury-600 rounded-lg hover:bg-luxury-700 cursor-pointer">
            ...
            <h3 class="font-semibold text-lg mb-4 text-luxury-100"><i class="fas fa-clock text-luxury-400 mr-2"></i>Check-in / Check-out Options</h3>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                <div class="p-4 border border-luxury-600 rounded-lg">
                    <label class="block font-medium mb-2 text-luxury-200">Request Early Check-in Time</label>
                ...
                <div class="p-4 border border-luxury-600 rounded-lg">
                    <label class="block font-medium mb-2 text-luxury-200">Request Late Check-out Time</label>
            ...
            <div class="mb-8">
                ...
                <textarea name="special_notes" rows="3" class="w-full px-4 py-3 border border-luxury-600 rounded-lg focus:ring-2 focus:ring-luxury-400 outline-none bg-luxury-700 text-luxury-100 placeholder-luxury-300" placeholder="Any additional requests or notes..."><?php echo sanitize($pendingData['special_notes'] ?? $_POST['special_notes'] ?? ''); ?></textarea>
            </div>

            <div class="bg-luxury-700 rounded-lg p-6 mb-8">
                <h3 class="font-semibold text-lg mb-4 text-luxury-100">Price Summary</h3>
                <div class="space-y-2">
...
<div id="authModal" class="fixed inset-0 z-50 hidden bg-luxury-900/50 backdrop-blur-sm items-center justify-center p-4">
    <div class="bg-luxury-800 rounded-2xl shadow-2xl max-w-md w-full p-8 text-center relative animate-modal border border-luxury-600">
        ...
        <button onclick="closeModal()" class="mt-6 text-sm text-luxury-300 hover:text-luxury-100 transition">Continue Browsing</button>
    </div>
</div>
