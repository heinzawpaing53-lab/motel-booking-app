                        ...
                        <tr class="border-b border-gray-100 hover:bg-gray-50">
                            ...
                            <td class="p-4">
                                <div class="flex items-center space-x-2">
                                    ...
                                    <a href="delete.php?id=<?php echo $floor['floor_id']; ?>" class="text-red-600 hover:text-red-800 bg-red-50 px-3 py-1.5 rounded-lg text-xs font-medium" onclick="return confirm('Are you sure you want to delete this floor?')"><i class="fas fa-trash mr-1"></i>Delete</a>
                                </div>
                            </td>
                        </tr>
                        <?php endforeach; ?>
