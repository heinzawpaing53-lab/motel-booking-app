    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            <div class="bg-gray-50 p-8 rounded-xl">
                <h3 class="font-[Playfair_Display] text-2xl font-bold mb-4"><i class="fas fa-bullseye text-amber-500 mr-2"></i>Our Mission</h3>
            ...
            <div class="bg-gray-50 p-8 rounded-xl">
                <h3 class="font-[Playfair_Display] text-2xl font-bold mb-4"><i class="fas fa-eye text-amber-500 mr-2"></i>Our Vision</h3>
        ...
        <div class="mb-12">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="flex items-start space-x-4 p-6 bg-gray-50 rounded-xl">
                    <div class="w-12 h-12 bg-amber-50 rounded-full flex items-center justify-center flex-shrink-0"><i class="fas <?php echo $s[0]; ?> text-amber-500"></i></div>
        ...
        <!-- Policies -->
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            <div class="bg-amber-50 p-8 rounded-xl">
                <h3 class="font-[Playfair_Display] text-2xl font-bold mb-4"><i class="fas fa-clock text-amber-500 mr-2"></i>Check-in / Check-out Policy</h3>
                <ul class="space-y-3 text-gray-600">
                    <li><i class="fas fa-sign-in-alt text-amber-500 mr-2"></i><strong>Check-in Time:</strong> 2:00 PM</li>
                    <li><i class="fas fa-sign-out-alt text-amber-500 mr-2"></i><strong>Check-out Time:</strong> 12:00 PM</li>
                    <li><i class="fas fa-id-card text-amber-500 mr-2"></i>Valid ID required at check-in</li>
                    <li><i class="fas fa-credit-card text-amber-500 mr-2"></i>Security deposit required</li>
                </ul>
            </div>
            <div class="bg-gray-50 p-8 rounded-xl">
                <h3 class="font-[Playfair_Display] text-2xl font-bold mb-4"><i class="fas fa-gavel text-amber-500 mr-2"></i>Rules & Regulations</h3>
                <ul class="space-y-3 text-gray-600">
                    <li><i class="fas fa-ban text-red-500 mr-2"></i>No smoking inside rooms</li>
                    <li><i class="fas fa-paw text-amber-500 mr-2"></i>Pets allowed with prior notice</li>
                    <li><i class="fas fa-volume-up text-amber-500 mr-2"></i>Quiet hours after 10 PM</li>
                    <li><i class="fas fa-glass-cheers text-amber-500 mr-2"></i>No parties or events without permission</li>
                </ul>
            </div>
        </div>
